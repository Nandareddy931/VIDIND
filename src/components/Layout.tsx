...
import { Search, Bell, User, X, Sparkles, ArrowLeft } from "lucide-react";
          ...
          <div className="flex items-center h-16 px-4 md:px-8 gap-4">
            {searchOpen ? (
              ...
              <>
                {/* Back Button */}
                {showBack && (
                  <button onClick={() => navigate(-1)} className="mr-1 p-2 rounded-full hover:bg-white/10 transition-colors">
